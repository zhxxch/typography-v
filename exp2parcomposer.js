...
var MEPCwasm = fetch("https://deliver.inv.ariant.cn/assets/wasm/mepc.wasm").then(Response => Response.arrayBuffer()).then(buffer => WebAssembly.compile(buffer)).then(module => {
